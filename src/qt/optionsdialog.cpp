    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new TrueGalaxyCashUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->truegalaxycashAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting TrueGalaxyCash."), QMessageBox::Ok);
