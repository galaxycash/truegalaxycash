/*
 * Qt4 truegalaxycash GUI.
 *
 * W.J. van der Laan 2011-2012
 * The TrueGalaxyCash Developers 2011-2012
 */

#include <QApplication>

#include "truegalaxycashgui.h"
...
TrueGalaxyCashGUI::TrueGalaxyCashGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
...
{
    resize(710, 540);
    setWindowTitle((tr("TrueGalaxyCash Core") + " - " + tr("Wallet")));
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/truegalaxycash"));
    setWindowIcon(QIcon(":icons/truegalaxycash"));
#else
...
TrueGalaxyCashGUI::~TrueGalaxyCashGUI()
{
...
void TrueGalaxyCashGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a TrueGalaxyCash address"));
    ...
    websiteAction = new QAction(QIcon(":/icons/truegalaxycash"), tr("Website"), this);
    websiteAction->setToolTip(tr("Open TrueGalaxyCash website"));

    twitterAction = new QAction(QIcon(":/icons/twitter"), tr("Twitter"), this);
    twitterAction->setToolTip(tr("Open TrueGalaxyCash twitter"));

    discordAction = new QAction(QIcon(":/icons/discord"), tr("Discord"), this);
    discordAction->setToolTip(tr("Open TrueGalaxyCash discord"));

    telegramAction = new QAction(QIcon(":/icons/telegram"), tr("Telegram"), this);
    telegramAction->setToolTip(tr("Open TrueGalaxyCash telegram"));

    githubAction = new QAction(QIcon(":/icons/github"), tr("Github"), this);
    githubAction->setToolTip(tr("Open TrueGalaxyCash github"));

    quitAction = new QAction(QIcon(":/icons/quit"), tr("E&xit"), this);
    quitAction->setToolTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
    aboutAction = new QAction(QIcon(":/icons/truegalaxycash"), tr("&About TrueGalaxyCash"), this);
    aboutAction->setToolTip(tr("Show information about TrueGalaxyCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for TrueGalaxyCash"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/truegalaxycash"), tr("&Show / Hide"), this);
...
void TrueGalaxyCashGUI::createMenuBar()
{
...
void TrueGalaxyCashGUI::createToolBars()
{
...
void TrueGalaxyCashGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/truegalaxycash_testnet"));
            setWindowIcon(QIcon(":icons/truegalaxycash_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/truegalaxycash_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip((tr("TrueGalaxyCash client")) + QString(" ") + tr("[testnet]"));
...
void TrueGalaxyCashGUI::setWalletModel(WalletModel *walletModel)
{
...
void TrueGalaxyCashGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("TrueGalaxyCash client"));
...
#ifndef Q_OS_MAC
void TrueGalaxyCashGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void TrueGalaxyCashGUI::optionsClicked()
{
...
void TrueGalaxyCashGUI::aboutClicked()
{
    AboutDialog dlg;
...
void TrueGalaxyCashGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TrueGalaxyCash network", "", count));
}

void TrueGalaxyCashGUI::setNumBlocks(int count)
{
...
void TrueGalaxyCashGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = (tr("TrueGalaxyCash")) + " - ";
...
void TrueGalaxyCashGUI::changeEvent(QEvent *e)
{
...
void TrueGalaxyCashGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void TrueGalaxyCashGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(TrueGalaxyCashUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void TrueGalaxyCashGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
            ...
            notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(TrueGalaxyCashUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
        }
    }
...
void TrueGalaxyCashGUI::gotoMasternodeManagerPage()
{
...
void TrueGalaxyCashGUI::gotoOverviewPage()
{
...
void TrueGalaxyCashGUI::gotoHistoryPage()
{
...
void TrueGalaxyCashGUI::gotoAddressBookPage()
{
...
void TrueGalaxyCashGUI::gotoReceiveCoinsPage()
{
...
void TrueGalaxyCashGUI::gotoSendCoinsPage()
{
...
void TrueGalaxyCashGUI::gotoSignMessageTab(QString addr)
{
...
void TrueGalaxyCashGUI::gotoVerifyMessageTab(QString addr)
{
...
void TrueGalaxyCashGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void TrueGalaxyCashGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid TrueGalaxyCash address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void TrueGalaxyCashGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void TrueGalaxyCashGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void TrueGalaxyCashGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void TrueGalaxyCashGUI::backupWallet()
{
...
void TrueGalaxyCashGUI::changePassphrase()
{
...
void TrueGalaxyCashGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void TrueGalaxyCashGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void TrueGalaxyCashGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void TrueGalaxyCashGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void TrueGalaxyCashGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void TrueGalaxyCashGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void TrueGalaxyCashGUI::updateStakingIcon()
{
    updateWeight();
...
void TrueGalaxyCashGUI::handleRestart(QStringList args)
{
    if (!ShutdownRequested())
...
void TrueGalaxyCashGUI::openWebsite()
{
    QDesktopServices::openUrl(QUrl("https://truegalaxycash.info"));
}

void TrueGalaxyCashGUI::openTwitter()
{
    QDesktopServices::openUrl(QUrl("https://twitter.com/cash_galaxy"));
}

void TrueGalaxyCashGUI::openDiscord()
{
    QDesktopServices::openUrl(QUrl("https://discord.gg/NseejAk"));
}

void TrueGalaxyCashGUI::openTelegram()
{
    QDesktopServices::openUrl(QUrl("http://t.me/truegalaxycash"));
}

void TrueGalaxyCashGUI::openGithub()
{
    QDesktopServices::openUrl(QUrl("https://github.com/truegalaxycash/truegalaxycash"));
}

void TrueGalaxyCashGUI::openCryptohub()
{
    QDesktopServices::openUrl(QUrl("https://cryptohub.online/market/TGCH/"));
}
