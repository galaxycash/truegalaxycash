...
/**
  TrueGalaxyCash GUI main class. This class represents the main window of the TrueGalaxyCash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TrueGalaxyCashGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit TrueGalaxyCashGUI(QWidget *parent = 0);
    ~TrueGalaxyCashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a truegalaxycash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
