...
/** TrueGalaxyCash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TrueGalaxyCashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TrueGalaxyCashUnits(QObject *parent);

    /** TrueGalaxyCash units.
      @note Source: https://en.truegalaxycash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TGCH,
...
typedef TrueGalaxyCashUnits::Unit TrueGalaxyCashUnit;
