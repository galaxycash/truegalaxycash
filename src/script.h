...
#ifndef TRUEGALAXYCASH_SCRIPT_H
#define TRUEGALAXYCASH_SCRIPT_H
...
public:
    ...
    explicit CScript(const arith_uint256& b) { operator<<(b); }
    ...
    CScript& operator<<(const arith_uint256& b)
    {
        operator<<(b.getuint256());
        return *this;
    }
