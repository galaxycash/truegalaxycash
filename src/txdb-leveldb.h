...
#ifndef TRUEGALAXYCASH_LEVELDB_H
#define TRUEGALAXYCASH_LEVELDB_H
...
public:
    ...
    bool ReadBestInvalidTrust(arith_uint256& bnBestInvalidTrust);
    bool WriteBestInvalidTrust(arith_uint256 bnBestInvalidTrust);
