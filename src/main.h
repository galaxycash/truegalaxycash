...
#ifndef TRUEGALAXYCASH_MAIN_H
#define TRUEGALAXYCASH_MAIN_H
...
static const unsigned int DEFAULT_MAX_ORPHAN_BLOCKS = 120;
/** The maximum number of entries in an 'inv' protocol message */
static const unsigned int MAX_INV_SZ = 50000;
/** PoS Reward Fixed */
static const int64_t COIN_YEAR_REWARD = 10 * CENT; // 10%
/** MasterNode required collateral */
static const unsigned int MN_COLLATERAL = 1000;
static const unsigned int MN_COLLATERAL2 = MN_COLLATERAL - 1;
inline int64_t MasternodeCollateral(int nHeight) { return MN_COLLATERAL; }
/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 35000000 * COIN; // 35M COINS
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
/** Max block file size **/
static const int32_t MAX_BLOCK_FILE_SIZE = 1 * 1000000; // 1 megabytes
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, const bool ProofOfStake);
...
public:
    ...
    /** Amount of truegalaxycashs spent by this transaction.
    ...
    /** Amount of truegalaxycashs coming in to this transaction
...
{
public:
    static const int MINIMAL_VERSION = 1;
...
class CCompressedBlock : public CBlock
{
public:
    ...
    void DecompressTransaction(int offset, CTransaction *tx);
};
