...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("paytxfee",      ValueFromAmount(std::max<int64_t>(GetMinTransactionFee(), nTransactionFee))));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <truegalaxycashaddress>\n"
            "Return information about <truegalaxycashaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <truegalaxycashpubkey>\n"
            "Return information about <truegalaxycashpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <truegalaxycashaddress> <signature> <message>\n"
