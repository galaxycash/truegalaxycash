...
contains(TRUEGALAXYCASH_NEED_QT_PLUGINS, 1) {
    DEFINES += TRUEGALAXYCASH_NEED_QT_PLUGINS
...
HEADERS += src/qt/truegalaxycashgui.h \
    ...
    src/qt/truegalaxycashaddressvalidator.h \
    src/kernel.h \
    src/addrman.h \
    src/base58.h \
    src/chainparams.h \
    ...
    src/qt/truegalaxycashamountfield.h \
    src/wallet.h \
    src/keystore.h \
...
SOURCES += src/qt/truegalaxycash.cpp src/qt/truegalaxycashgui.cpp \
    ...
    src/qt/truegalaxycashaddressvalidator.cpp \
    src/base58.cpp \
    src/kernel.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    ...
    src/qt/truegalaxycashstrings.cpp \
    src/qt/truegalaxycashamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    ...
    src/qt/truegalaxycashunits.cpp \
...
# also add new translations to src/qt/truegalaxycash.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/truegalaxycash_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/truegalaxycash-qt.rc src/makefile.unix
...
macx:ICON = src/qt/res/icons/truegalaxycash.icns
macx:TARGET = "TrueGalaxyCash-Qt"
